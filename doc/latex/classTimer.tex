...
\hypertarget{classTimer_aadc180bcac64bc164f134d9c8076e1a3}{\index{\-Timer@{\-Timer}!\-Get@{\-Get}}
\index{\-Get@{\-Get}!Timer@{\-Timer}}
\subsubsection[{\-Get}]{\setlength{\rightskip}{0pt plus 5cm}double {\bf \-Timer\-::\-Get} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\end{DoxyReturn}
\hypertarget{classTimer_a044e56cf40905d2f5037745e44cc3881}{\index{\-Timer@{\-Timer}!\-Has\-Period\-Passed@{\-Has\-Period\-Passed}}
\index{\-Has\-Period\-Passed@{\-Has\-Period\-Passed}!Timer@{\-Timer}}
\subsubsection[{\-Has\-Period\-Passed}]{\setlength{\rightskip}{0pt plus 5cm}bool {\bf \-Timer\-::\-Has\-Period\-Passed} (
\begin{DoxyParamCaption}
\item[{double}]{period}
\end{DoxyParamCaption}
...
\end{DoxyReturn}
\hypertarget{classTimer_ae7c0c1e7d12de4b8a6e7c64e451cdd2a}{\index{\-Timer@{\-Timer}!\-Reset@{\-Reset}}
...
\-Make the timer start\-Time the current time so new requests will be relative to now \hypertarget{classTimer_a4e607b129b392c11adddd9641a320436}{\index{\-Timer@{\-Timer}!\-Start@{\-Start}}
...
\-Start the timer running. \-Just set the running flag to true indicating that all time requests should be relative to the system clock. \hypertarget{classTimer_a6379e797f968aaee6ac3bb12dc6b81c5}{\index{\-Timer@{\-Timer}!\-Stop@{\-Stop}}
