...
\begin{Desc}
\item[\hyperlink{bug__bug000003}{Bug}]All pointer-\/based parameters seem to return an error.\end{Desc}
...
\begin{Desc}
\item[\hyperlink{bug__bug000004}{Bug}]All pointer-\/based parameters seem to return an error.\end{Desc}
